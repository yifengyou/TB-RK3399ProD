...
export BUILD_TAG="RK3399ProD_k6.6.y_${set_rootfs}"
...
mkdir -p tb-rk3399prod-image
cd tb-rk3399prod-image

wget -c https://github.com/yifengyou/TB-RK3399ProD/releases/download/ophub-kernel-6.6.y/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/TB-RK3399ProD/releases/download/ophub-kernel-6.6.y/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/TB-RK3399ProD/releases/download/ophub-kernel-6.6.y/config-6.6.y-kdev
ls -alh config-6.6.y-kdev
md5sum config-6.6.y-kdev

wget -c https://github.com/yifengyou/TB-RK3399ProD/releases/download/ophub-kernel-6.6.y/System.map-6.6.y-kdev
ls -alh System.map-6.6.y-kdev
md5sum System.map-6.6.y-kdev

wget -c https://github.com/yifengyou/TB-RK3399ProD/releases/download/ophub-kernel-6.6.y/rk3399pro-toybrick-prod.dtb
ls -alh rk3399pro-toybrick-prod.dtb
md5sum rk3399pro-toybrick-prod.dtb

wget -c https://github.com/yifengyou/TB-RK3399ProD/releases/download/ophub-kernel-6.6.y/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
...
mkdir -p /mnt/dtb
cp -a rk3399pro-toybrick-prod.dtb /mnt/dtb/
...
label l0
	...
	fdt /dtb/rk3399pro-toybrick-prod.dtb
