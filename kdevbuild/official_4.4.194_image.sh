...
export BUILD_TAG="RK3588-OWL_k4.4.194_${set_rootfs}"
...
mkdir -p official-kernel-4.4.194
cd official-kernel-4.4.194

wget -c https://github.com/yifengyou/TB-RK3399ProD/releases/download/official-kernel-4.4.194/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/TB-RK3399ProD/releases/download/official-kernel-4.4.194/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/TB-RK3399ProD/releases/download/official-kernel-4.4.194/config-4.4.194-kdev
ls -alh config-4.4.194-kdev
md5sum config-4.4.194-kdev

wget -c https://github.com/yifengyou/TB-RK3399ProD/releases/download/official-kernel-4.4.194/System.map-4.4.194-kdev
ls -alh System.map-4.4.194-kdev
md5sum System.map-4.4.194-kdev

wget -c https://github.com/yifengyou/TB-RK3399ProD/releases/download/official-kernel-4.4.194/rk3399pro-toybrick-prod-linux.dtb
ls -alh rk3399pro-toybrick-prod-linux.dtb
md5sum rk3399pro-toybrick-prod-linux.dtb

wget -c https://github.com/yifengyou/TB-RK3399ProD/releases/download/official-kernel-4.4.194/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
...
mkdir -p /mnt/dtb
cp -a rk3399pro-toybrick-prod-linux.dtb /mnt/dtb/
cp -f Image /mnt/vmlinuz-4.4.194-kdev
cp -f config-4.4.194-kdev /mnt/config-4.4.194-kdev
cp -f System.map-4.4.194-kdev /mnt/System.map-4.4.194-kdev
touch /mnt/initrd.img-4.4.194-kdev
...
label l0
	menu label Linux kernel 4.4.194-kdev
	linux vmlinuz-4.4.194-kdev
	initrd initrd.img-4.4.194-kdev
	fdt /dtb/rk3399pro-toybrick-prod-linux.dtb
...
label l0r
	menu label Linux kernel 4.4.194-kdev (rescue target)
	linux vmlinuz-4.4.194-kdev
	initrd initrd.img-4.4.194-kdev
	fdt /dtb/rk3399pro-toybrick-prod-linux.dtb
